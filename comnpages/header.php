...
<nav class="navbar navbar-inverse" style="margin-bottom:0;background:#19bcdb;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand " href="index.php"><span  style="font-weight: bold;color:#ffffff; font-size: 25px;">LifeCare</span></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" >
        ...
        <li><a href="blog.php">Schemes</a></li>
         <li><a href="./admin/login.php">Admin Login</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="./doctor/doctorlogin.php"><span class="glyphicon glyphicon-user"></span> Doctor</a></li>
        <li><a href="patientlogin.php"><span class="glyphicon glyphicon-log-in"></span> Patient</a></li>
      </ul>
    </div>
  </div>
</nav>
